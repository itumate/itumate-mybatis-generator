package com.mingrn.mybatis.generator.util;

import com.mingrn.mybatis.generator.core.CodeGenerator;
import com.mingrn.mybatis.generator.core.ProjectConstant;

import java.io.File;

/**
 * 数据表 DAO、Model、DTO、Mapper 文件生成工具类
 *
